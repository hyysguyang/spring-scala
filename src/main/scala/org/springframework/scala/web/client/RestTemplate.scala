 ...
 */
class RestTemplate(val javaTemplate: org.springframework.web.client.RestOperations = new org.springframework.web.client.RestTemplate) {
     ...
     */
    def execute[T](url: String, method: HttpMethod, uriVariables: Any*)(requestFunction: ClientHttpRequest ⇒ Unit)(responseFunction: ClientHttpResponse ⇒ T): Option[T] = {
        Option(javaTemplate
     ...
     * @return an arbitrary object, as returned by the response function
     */
    def execute[T](url: String, method: HttpMethod, uriVariables: Map[String, _])(requestFunction: ClientHttpRequest ⇒ Unit)(responseFunction: ClientHttpResponse ⇒ T): Option[T] = {
        Option(javaTemplate
            .execute(url, method, functionToRequestCallback(requestFunction), functionToResponseExtractor(responseFunction),
                uriVariables.asJava))
    }
     ...
     */
    def execute[T](url: URI, method: HttpMethod)(requestFunction: ClientHttpRequest ⇒ Unit)(responseFunction: ClientHttpResponse ⇒ T): Option[T] = {
